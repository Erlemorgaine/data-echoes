...
<template>
  <div class="movie-page">
    ...
    <MoviesTextBlock
      :paragraphs="[
        `On the 15th of January 2015, April Reign posted a hashtag on Twitter that would go viral: <strong>#OscarsSoWhite</strong>. It commented on the lack of representation of people with a BIPOC background among the nominees for the <strong>87th Academy Awards</strong>, and was later revived to do the same for the nominees of the 88th Academy Awards. `,
        `As someone who loves movies and always keeps an eye on what is going on with the Oscars, I was curious to see the patterns that would emerge once I put the data on Oscar nominees in a visualization. I decided to gather data starting from the year 2010 and ending in the year that I'm writing this, which is 2024, because I was curious <strong>how (not-)diverse the nominees had been in the ceremonies leading up to the year that the hashtag went viral</strong>, and <strong>how things have developed since</strong>. 2010 is a bit of an arbitrary cutoff point; my reasoning was that by that time, the dialogue concerning diversity had already been circulating in US society (and maybe also in Hollywood?), while if I would go back a whole lot of years more, the lack of diversity would probably be a given. I also wanted to keep the focal point on the years surrounding the hashtag moment - and 2010 is a nice round number 😄.`,
        `In terms of categories, I chose to visualize the (usually) single-nominee categories that usually create the most buzz - <strong>the actor and director categories</strong> - as well as <strong>cast of the Best Picture nominees</strong>. My original idea was to literally visualize every category, but gathering data on every nominee's background would have been a lot of work that I didn't really have space for at that moment 🙈.`,
      ]"
    />
